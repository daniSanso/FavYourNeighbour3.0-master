...
EditText edText,comText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enviarBut=(Button) findViewById(R.id.buttonEnviar2) ;
        edText=(EditText) findViewById(R.id.idLblTituloComentario1) ;
        comText=(EditText) findViewById(R.id.idLblComentario1) ;
